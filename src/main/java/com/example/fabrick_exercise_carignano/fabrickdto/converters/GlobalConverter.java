...
import com.example.fabrick_exercise_carignano.fabrickdto.moneytransfer.fabrick.*;
import com.example.fabrick_exercise_carignano.fabrickdto.moneytransfer.local.*;
import com.example.fabrick_exercise_carignano.fabrickdto.transaction.fabrick.TransactionFabrick;
import com.example.fabrick_exercise_carignano.fabrickdto.transaction.fabrick.TransactionTypeFabrick;
import com.example.fabrick_exercise_carignano.fabrickdto.transaction.local.Transaction;
import com.example.fabrick_exercise_carignano.fabrickdto.transaction.local.TransactionType;
